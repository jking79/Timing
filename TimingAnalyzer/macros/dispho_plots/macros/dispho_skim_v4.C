...
// phoseedootMafter_0*(phoseedadcToGeV_0/phoseedE_0)
  ...
  //   std::cout << "Processing Data" << std::endl;
	...
	auto seedAmp_1 = (phoseedadcToGeV_1/phoseedE_1);
        ...
        amp_0 = phoseedootMax_0*seedAmp_0;
        amp_1 = phoseedootMax_1*seedAmp_1;
	xbin = int(amp_0/step);
        ybin = int(amp_1/step);
...
//	std::cout << "bin values: " << xbin << " : " << ybin << " maxbin : " << maxbin << " step: " << step << std::endl;
	...
	twodeeMax[xbin][ybin]->Fill(diff_t);
	onedeeMax_0[xbin]->Fill(diff_t);
        onedeeMaxCount_0[xbin]++;
	onedeeMax_1[ybin]->Fill(diff_t);
        ...
        twodeeBefore[xbin][ybin]->Fill(diff_t);
        onedeeBefore_0[xbin]->Fill(diff_t);
        onedeeBeforeCount_0[xbin]++;
        onedeeBefore_1[ybin]->Fill(diff_t);
        ...
        twodeeAfter[xbin][ybin]->Fill(diff_t);
        onedeeAfter_0[xbin]->Fill(diff_t);
        onedeeAfterCount_0[xbin]++;
        onedeeAfter_1[ybin]->Fill(diff_t);
...
void dispho_skim_v4::MakePlots()
{
   ...
   twodeeMaxMuHist.GetZaxis()->SetTitle("#mu(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   twodeeMaxSigmaHist.GetZaxis()->SetTitle("#sigma(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   onedeeMaxMuHist_0.GetYaxis()->SetTitle("#mu(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   onedeeMaxMuHist_1.GetYaxis()->SetTitle("#mu(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   twodeeBeforeMuHist.GetZaxis()->SetTitle("#mu(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   twodeeBeforeSigmaHist.GetZaxis()->SetTitle("#sigma(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   onedeeBeforeMuHist_0.GetYaxis()->SetTitle("#mu(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   onedeeBeforeMuHist_1.GetYaxis()->SetTitle("#mu(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   twodeeAfterMuHist.GetZaxis()->SetTitle("#mu(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   twodeeAfterSigmaHist.GetZaxis()->SetTitle("#sigma(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   onedeeAfterMuHist_0.GetYaxis()->SetTitle("#mu(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
   ...
   onedeeAfterMuHist_1.GetYaxis()->SetTitle("#mu(#delta(Pho_{t}^{seed})) [ns] p_{t} ordered");
