...
void plot2dResolution( string califilename, string indir, string infilelist, string outfilename, string tvarname, string calimapname, string isd_type ){
    ...
    std::cout << " fCaliFile : " << fCaliFile << std::endl;
...
int main ( int argc, char *argv[] ){
        ...
        if( argc != 8 ) { std::cout << "Insufficent arguments." << std::endl; }
        else {
                auto califilename = argv[1];
					 auto indir = argv[2];
                auto infilename = argv[3];
                auto outfilename = argv[4];
                auto tvarname = argv[5];
					 auto calimapname = argv[6];
                auto isd_type = argv[7];
      			 plot2dResolution( califilename, indir, infilename, outfilename, tvarname, calimapname, isd_type );
        }
        return 1;
}
