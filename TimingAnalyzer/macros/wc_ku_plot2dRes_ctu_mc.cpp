...
//     set branches to get from fInFile : fInTree
    ...
    fInTree->SetBranchAddress("phoseedpcTOF_0", &phoseedTOF_0, &b_phoseedTOF_0);
    ...
    fInTree->SetBranchAddress("phoseedpcTOF_1", &phoseedTOF_1, &b_phoseedTOF_1);
...
//     get maps from fCaliFile
    ...
    string ybinstr("CONSTANT 256 -3 3");
    ...
    for (auto entry = 0U; entry < nEntries; entry++){
        ...
        auto yfill0 = phoseedtime_0 - phoseedTOF_0; // - phoseedtimeCaliIc_0 - phoseedTOF_0;
        auto yfill1 = phoseedtime_1 - phoseedTOF_1; // - phoseedtimeCaliIc_1 - phoseedTOF_1;
        auto yfill = yfill0 - yfill1;
