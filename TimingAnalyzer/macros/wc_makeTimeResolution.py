...
#skiminfile='dispho_raw_Run2018A_315322.root'
#skiminfile='ku_twotier_run18D_320712_dispho.root'
#skiminfile='output_235.root'
#skiminfile='ku_rhcomp_twotier_run18D_dispho.root'
#skiminfile='dispho_mini_Run2018A_315322.root'
#skiminfile='dispho_tt_Run2018B.root'
#skiminfile='dispho_tt_loc_Run2018B_pptest.root'
#skiminfile='dispho_tt_loc_Run2018B_v1_pptest.root'
#skiminfile='dispho_tt_loc_Run2018B_317080-319077_0000_pptest.root'
#skiminfile='dispho_tt_Run2018A.root'
#skiminfile='dispho_tt_Run2018C.root'
#skiminfile='dispho_tt_Run2018D.root'
#skiminfile='dispho_tt_Run2018D_320673-320824.root'
#skiminlist='dispho_tt_Run2018D_320673-320824.txt'
#skiminfile='dispho_tt_Run2018A_315257-315488.root'
#skiminlist='dispho_tt_Run2018A_315257-315488.txt'
#skiminfile='dispho_tt_Run2018B_global.root'
#skiminfile='dispho_tt_Run2018B_local_icv2.root'
#skiminfile='dispho_tt_Run2018B_local.root'
#skiminfile='dispho_2t_eg2018B_local_pptest.root'
#skiminfile='dispho_2t_eg2018B_global_preplot.root'
#skiminfile='dispho_tt_Run2018B_notof.root'
#skiminfile='dispho_2t_glo_Run2018D_320673_320824_v2_mf.root'
#skiminfile='dispho_tt_loc_Run2018C_319337-319579_0001.root'
skiminfile='dispho_tt_loc_Run2018C_319337-319579_0002.root'  # preplot for average methods

#skiminfile='dispho_tt_Run2018D_320673-320824_mf.root'
#skiminfile='dispho_2t_glo_Run2018D_320673_320824_v2_mf.root'
#skiminfile='dispho_tt_Run2018pABCD_mf.root'
#skiminfile='dispho_2t_glo_Run2018pABCD_mf.root'
...
#preplotoutfile='dispho_tt_Run2018B_preplot.root'
#preplotoutfile='dispho_tt_Run2018C_preplot.root'
#preplotoutfile='dispho_tt_Run2018D_preplot.root'
#preplotoutfile='dispho_2t_eg2018B_local_icv2_i25_e5e5_preplot.root'
#preplotoutfile='dispho_tt_Run2018D_global_icv2_i25_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018D_local_globalic_i25_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018Dmf_local_icgv2_i50_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018pABCDmf_local_icgv2_Run2018Dmf_i50_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018pABCDmf_local_icgv2b_2018pABCDmf_i50_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018pABCDmf_local_icgv2b_2018pABCDmf_i50_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018pABCDmf_local_e5cali_preplot.root'
#preplotoutfile='dispho_tt_Run2018pABCDmf_local_icgv2b_Run2018D_320673_320824_v2_mf_i50_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018D_same_local_icgv2b_Run2018D_320673_320824_v2_mf_i50_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018pABCDmf_local_icgv3_Run2018D_320673_320824_v2_mf_i100_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018D_same_local_icgv3b_Run2018D_320673_320824_v2_mf_i100_e5e3_preplot.root'
#preplotoutfile='dispho_tt_Run2018B_global_preplot.root'
#preplotoutfile='dispho_tt_Run2018B_global_ic_preplot.root'
#preplotoutfile='dispho_tt_Run2018B_local_preplot.root'
preplotoutfile='dispho_tt_Run2018B_local_ic_preplot.root'
#preplotoutfile='dispho_tt_Run2018B_notof_preplot.root'
#preplotoutfile='dispho_tt_Run2018B_tof_preplot.root'
#preplotoutfile='dispho_tt_Run2018B_inter_preplot.root'
#preplotoutfile='dispho_tt_Run2018pABCDmf_local_e5localcali_preplot.root'
...
#caliinfile3='dispho_2t_glo_Run2018Dmf_v2_320673_320824_v3_t2_i100_e5e3.root'
#caliinfile3b='dispho_2t_glo_Run2018Dmf_v2_320673_320824_v3b_t2_i100_e5e3.root'
#caliinfile2='dispho_2t_glo_Run2018Dmf_v2_320673_320824_v2_i50_e5e3.root'
#caliinfile2a='dispho_2t_glo_Run2018Dmf_v2_320673_320824_v2a_i50_e5e3.root'
#caliinfile2b='dispho_2t_glo_Run2018Dmf_v2_320673_320824_v2b_i50_e5e3.root'
caliinfile2='dispho_tt_Run2018pABCDmf_global_v2_i50_e5e3.root'
caliinfile2a='dispho_tt_Run2018pABCDmf_global_v2a_i50_e5e3.root'
caliinfile2b='dispho_tt_Run2018pABCDmf_global_v2b_i50_e5e3.root'
caliinfile3='dispho_tt_Run2018pABCDmf_global_v3_i100_e5e3.root'
caliinfile4a='dispho_tt_Run2018pABCDmf_global_v4a_i50_e5e3.root'
caliinfile=caliinfile3
...
dopreplot1='./wc_ku_Preplot.obj '
#dopreplot='root -b -q -l wc_ku_Preplot_nowt.C\(\\"'
dopreplot2='./wc_ku_Preplot_ic.obj '
dopreplotupdate1='./wc_ku_PreplotUpdate_ic.cpp '
...
def do_plots( plot_list ):
	...
	#+sp+outdir
        ...
        os.system(cmd2d)
        #----  add clean up
	writedir = plotdir+outdir+"_"+date+"/"
	if( not os.path.exists(writedir) ) : os.mkdir(writedir)
        #for ext in [ 'png', 'pdf' ] : 
	#	for sca in [ 'lin', 'log' ] : 
	#		fmove( entry[1]+'_'+sca+'.'+ext , writedir )
	fmove( entry[1]+'.root', writedir )
        #fmove( entry[1]+'_integrals.log', writedir )
...
def jwk_break():
	...
	#shutil.move(f, 'dest_folder')		
        ## run fitter, getting 2D plots from before
        cmdtf=timefit+sp+writedir+entry[1]+'.root'+sp+entry[0]+sp+misc_fit_cf+sp+timefit_cf+sp+era+sp+entry[2]+timefile
        print( '>>>>>>>>>>>>>>>>>  ' + cmdtf )
	#+sp+outdir
        os.system(cmdtf)
	#-----  add clean up
		...
		for sca in [ 'lin', 'log', 'lin_logx', 'log_logx' ] : 
			for typ in [ 'mu', 'sigma' ] :
				...
				fmove( typ+'_'+entry[2]+'_timefit_'+sca+'.'+ext , writedir )
				#fmove( typ+'_'+entry[2]+'_timefit_'+sca+'.'+ext , writedir )
	fmove( entry[2]+'_timefit.root', writedir )
        fmove( entry[2]+'_timefit_fitinfo.log', writedir )
...
def do_preplot():
        ...
        cmdpreplot=dopreplot1+skimoutdir+skiminfile
        print(cmdpreplot)
        os.system(cmdpreplot)

def do_preplotic():

	cmdpreplot=dopreplot2+caliindir+caliinfile+sp+skimoutdir+skiminfile+sp+skimoutdir+preplotoutfile+sp+iterations
	print(cmdpreplot)
	os.system(cmdpreplot)

def do_preploticupdate():

        cmdpreplot=dopreplotupdate1+caliindir+caliinfile+sp+skimoutdir+skiminfile+sp+calitreename+sp+calibranchname+sp+iterations
        print(cmdpreplot)
        os.system(cmdpreplot)
