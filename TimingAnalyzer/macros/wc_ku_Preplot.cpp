...
void wc_ku_Preplot( string infilename ){

    std::cout << "open input files" << std::endl;
    string disphotreename("disphotree");
    string treename("stdcalitree");

    auto fInFile = TFile::Open(infilename.c_str(), "update");
    fInFile->cd();
    auto fInTree = (TTree*)fInFile->Get(disphotreename.c_str());
    TTree* fCaliTree = new TTree( treename.c_str(), treename.c_str());

    std::cout << "fInFile : " << fInFile  << " fInTree : " << fInTree << " fCaliTree : " << fCaliTree << std::endl;
    ...
    auto ebmapwte5 = (TH2F*)fInFile->Get("AveXtalWtOOTStcRecTimeE5EBMap");
    auto epmapwte5 = (TH2F*)fInFile->Get("AveXtalWtOOTStcRecTimeE5EPMap");
    auto emmapwte5 = (TH2F*)fInFile->Get("AveXtalWtOOTStcRecTimeE5EMMap");
    ...
    auto b_phoseedtimeCaliE0_0 = fCaliTree->Branch("phoseedtimeCaliE0_0",&phoseedtimeCaliE0_0);
    auto b_phoseedtimeCaliE0_1 = fCaliTree->Branch("phoseedtimeCaliE0_1",&phoseedtimeCaliE0_1);
    auto b_phoseedtimeCaliE1_0 = fCaliTree->Branch("phoseedtimeCaliE1_0",&phoseedtimeCaliE1_0);
    auto b_phoseedtimeCaliE1_1 = fCaliTree->Branch("phoseedtimeCaliE1_1",&phoseedtimeCaliE1_1);
    auto b_phoseedtimeCali2E1_0 = fCaliTree->Branch("phoseedtimeCali2E1_0",&phoseedtimeCali2E1_0);
    auto b_phoseedtimeCali2E1_1 = fCaliTree->Branch("phoseedtimeCali2E1_1",&phoseedtimeCali2E1_1);
    auto b_phoseedtimeCali4E1_0 = fCaliTree->Branch("phoseedtimeCali4E1_0",&phoseedtimeCali4E1_0);
    auto b_phoseedtimeCali4E1_1 = fCaliTree->Branch("phoseedtimeCali4E1_1",&phoseedtimeCali4E1_1);
    auto b_phoseedtimeCaliE2_0 = fCaliTree->Branch("phoseedtimeCaliE2_0",&phoseedtimeCaliE2_0);
    auto b_phoseedtimeCaliE2_1 = fCaliTree->Branch("phoseedtimeCaliE2_1",&phoseedtimeCaliE2_1);
    auto b_phoseedtimeCaliE5_0 = fCaliTree->Branch("phoseedtimeCaliE5_0",&phoseedtimeCaliE5_0);
    auto b_phoseedtimeCaliE5_1 = fCaliTree->Branch("phoseedtimeCaliE5_1",&phoseedtimeCaliE5_1);
    auto b_phoseedtimeCali2E5_0 = fCaliTree->Branch("phoseedtimeCali2E5_0",&phoseedtimeCali2E5_0);
    auto b_phoseedtimeCali2E5_1 = fCaliTree->Branch("phoseedtimeCali2E5_1",&phoseedtimeCali2E5_1);
    auto b_phoseedtimeCali4E5_0 = fCaliTree->Branch("phoseedtimeCali4E5_0",&phoseedtimeCali4E5_0);
    auto b_phoseedtimeCali4E5_1 = fCaliTree->Branch("phoseedtimeCali4E5_1",&phoseedtimeCali4E5_1);
    auto b_phoseedtimeCaliE10_0 = fCaliTree->Branch("phoseedtimeCaliE10_0",&phoseedtimeCaliE10_0);
    auto b_phoseedtimeCaliE10_1 = fCaliTree->Branch("phoseedtimeCaliE10_1",&phoseedtimeCaliE10_1);

    auto b_phoseedtimeCaliCl_0 = fCaliTree->Branch("phoseedtimeCaliCl_0",&phoseedtimeCaliCl_0);
    auto b_phoseedtimeCaliCl_1 = fCaliTree->Branch("phoseedtimeCaliCl_1",&phoseedtimeCaliCl_1);
    ...
    auto b_phoseedtimeKuStcCaliE5_0 = fCaliTree->Branch("phoseedtimeKuStcCaliE5_0",&phoseedtimeKuStcCaliE5_0);
    auto b_phoseedtimeKuStcCaliE5_1 = fCaliTree->Branch("phoseedtimeKuStcCaliE5_1",&phoseedtimeKuStcCaliE5_1);

    auto b_phoseedtimeWootStcCaliE5_0 = fCaliTree->Branch("phoseedtimeWootStcCaliE5_0",&phoseedtimeWootStcCaliE5_0);
    auto b_phoseedtimeWootStcCaliE5_1 = fCaliTree->Branch("phoseedtimeWootStcCaliE5_1",&phoseedtimeWootStcCaliE5_1);
	...
	int adjust = 100.0;
		...
		phoseedtimeKuStcCaliE5_0 = ebmapkue5->GetBinContent( phoseedI2_0 + bin_offset, phoseedI1_0 ) - adjust;	
                phoseedtimeWootStcCaliE5_0 = ebmapwte5->GetBinContent( phoseedI2_0 + bin_offset, phoseedI1_0 ) - adjust;
		...
		//}
                ...
                phoseedtimeCaliE0_0 = epmape0->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliE1_0 = epmape1->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCali2E1_0 = epmap2e1->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCali4E1_0 = epmap4e1->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliE2_0 = epmape2->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliE5_0 = epmape5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCali2E5_0 = epmap2e5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCali4E5_0 = epmap4e5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliE10_0 = epmape10->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliCl_0 = epmapcl->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliIc_0 = epmapic->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeKuStcCaliE5_0 = epmapkue5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeWootStcCaliE5_0 = epmapwte5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                //std::cout << "Filling EP 0 with " << phoseedI2_0 << " by " << phoseedI1_0 << " : " << phoseedtimeCali_0 << " and " << phoseedtimeStcCali_0 << std::endl;
        }else if (phoseedEcal_0 == ECAL::EM ){
                phoseedtimeCaliE0_0 = emmape0->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliE1_0 = emmape1->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCali2E1_0 = emmap2e1->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCali4E1_0 = emmap4e1->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliE2_0 = emmape2->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliE5_0 = emmape5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCali2E5_0 = emmap2e5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCali4E5_0 = emmap4e5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliE10_0 = emmape10->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliCl_0 = emmapcl->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeCaliIc_0 = emmapic->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeKuStcCaliE5_0 = emmapkue5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
                phoseedtimeWootStcCaliE5_0 = emmapwte5->GetBinContent( phoseedI1_0, phoseedI2_0 ) - adjust;
		//std::cout << "Filling EM 0 with " << phoseedI2_0 << " by " << phoseedI1_0 << " : " << phoseedtimeCali_0 << " and " << phoseedtimeStcCali_0 << std::endl;
        }
	...
	if ( phoseedEcal_1 == ECAL::EB ){
                ...
                phoseedtimeWootStcCaliE5_1 = ebmapwte5->GetBinContent( phoseedI2_1 + bin_offset, phoseedI1_1 ) - adjust;
                ...
                phoseedtimeCaliE0_1 = epmape0->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliE1_1 = epmape1->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCali2E1_1 = epmap2e1->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCali4E1_1 = epmap4e1->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliE2_1 = epmape2->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliE5_1 = epmape5->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCali2E5_1 = epmap2e5->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCali4E5_1 = epmap4e5->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliE10_1 = epmape10->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliCl_1 = epmapcl->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliIc_1 = epmapic->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeKuStcCaliE5_1 = epmapkue5->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeWootStcCaliE5_1 = epmapwte5->GetBinContent( phoseedI1_1 + bin_offset, phoseedI2_1 ) - adjust;
                //std::cout << "Filling EP 1 with " << phoseedI2_1 << " by " << phoseedI1_1 << " : " << phoseedtimeCali_1 << " and " << phoseedtimeStcCali_1 << std::endl;
        }else if (phoseedEcal_1 == ECAL::EM ){
                phoseedtimeCaliE0_1 = emmape0->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliE1_1 = emmape1->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCali2E1_1 = emmap2e1->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCali4E1_1 = emmap4e1->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliE2_1 = emmape2->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliE5_1 = emmape5->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCali2E5_1 = emmap2e5->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCali4E5_1 = emmap4e5->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliE10_1 = emmape10->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliCl_1 = emmapcl->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeCaliIc_1 = emmapic->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeKuStcCaliE5_1 = emmapkue5->GetBinContent( phoseedI1_1, phoseedI2_1 ) - adjust;
                phoseedtimeWootStcCaliE5_1 = emmapwte5->GetBinContent( phoseedI1_1 + bin_offset, phoseedI2_1 ) - adjust;
                //std::cout << "Filling EM 1 with " << phoseedI2_1 << " by " << phoseedI1_1 << " : " << phoseedtimeCali_1 << " and " << phoseedtimeStcCali_1 << std::endl;
        }
    ...
    fCaliTree->Write();
    fInTree->AddFriend(fCaliTree);
    fInFile->Write();

    std::cout << "Cleaning up and Delete pointers." << std::endl;
...
int main ( int argc, char *argv[] ){
        ...
        if( argc != 2 ) { std::cout << "Insufficent arguments." << std::endl; }
        else {
                auto infilename = argv[1];
                wc_ku_Preplot( infilename );
        }
        return 1;
}
