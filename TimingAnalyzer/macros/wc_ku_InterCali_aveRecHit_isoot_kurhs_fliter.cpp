...
void wc_ku_InterCali_aveRecHit_mini( string indir, string infilelist, string outfilename ){
    ...
    const float kscc_offset = 0.f; //3101.0;//3351.0;
...
//    auto fInTree = (TTree*)fInFile->Get(disphotreename.c_str());
 ...
 //   } // end loop over inputfiles
    ...
    std::map<UInt_t,UInt_t> *  nicmaps[nAlgos] = {&numXtalRtStcRecTime, &numXtalRtOOTStcRecTime, &numXtalWtStcRecTime, &numXtalWtOOTStcRecTime,
