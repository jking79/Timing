...
//         get maps from fCaliFile
        ...
        for (auto entry = 0U; entry < nEntries; entry++){
            ...
            auto effa0 = phoseedE_0; //(phoseedE_0/phoseedadcToGeV_0)/phoseedpedrms12_0;
            auto effa1 = phoseedE_1; //(phoseedE_1/phoseedadcToGeV_1)/phoseedpedrms12_1;
...
int main ( int argc, char *argv[] ){
        ...
        if( argc != 7 ) { std::cout << "Insufficent arguments." << std::endl; }
                ...
                auto isd_type = argv[6];
      			 plot2dResolution( indir, infilelistname, outfilename, tvarname, calimapname, isd_type );
        }
        return 1;
}
