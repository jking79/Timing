...
void wc_ku_InterCali_aveRecHit_mini( string indir, string infilelist, string outfilename ){
    ...
    const int  nAlgos = 6; // RtStc, RtOOTStc, WtStc, WtOOTStc, MfootStc, MfootCCStc
...
//    auto fInTree = (TTree*)fInFile->Get(disphotreename.c_str());
 ...
 //   } // end loop over inputfiles
    ...
    std::map<UInt_t,Float_t> *  icmaps[nAlgos] = {&sumXtalRtStcRecTime, &sumXtalRtOOTStcRecTime, &sumXtalWtStcRecTime, &sumXtalWtOOTStcRecTime, 
