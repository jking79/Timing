...
void plot2dResolution( string califilename, string infilename, string outfilename, string tvarname, string calimapname, string isd_type, int brun, int erun ){
...
int main ( int argc, char *argv[] ){
        ...
        if( argc != 9 ) { std::cout << "Insufficent arguments." << std::endl; }
                ...
                auto erun = std::stoi(argv[8]);
      			 plot2dResolution( califilename, infilename, outfilename, tvarname, calimapname, isd_type, brun, erun );
        }
        return 1;
}
