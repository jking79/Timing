...
options.register('rlelist','events2016.txt',VarParsing.multiplicity.singleton,VarParsing.varType.string,'Events to Process');
## blinding
...
## outputFile Name
options.register('outputFileName','very_short_trial_run16D_dispho.root',VarParsing.multiplicity.singleton,VarParsing.varType.string,'output file name created by cmsRun');
