...
def docrab( dataset ):
	...
	secInputPaths = dataset[1] 
        ...
        config.Data.unitsPerJob    =  8000  #10000   #25000
	    ...
	    #trial          = "valtest38_2t94_2017D" # as 28 with /DoubleEG/Run2017D-17Nov2017-v1/MINIAOD globalTag=94X_dataRun2_ReReco_EOY17_v2
            ...
            #trial          = "twotier_kurh_v42" # as 41 above   units 10000   with req GTs 
            #trial          = "twotier_kurh_v43a" # as 41 above   units 8000 runtime 2750
            #trial          = "twotier_kurh_v43a" # as 41 above   units 8000 runtime 2750
            trial          = "tt_kurh_v16t2" # as 43 w/o time/mem reqs
	    ...
	    #2017   'globalTag=94X_dataRun2_v11' 
	    ...
	    #2016  'globalTag=94X_dataRun2_v10'
...
def run_multi():
        ...
        datasets = [
            ...
            ['/DoubleEG/Run2017B-31Mar2018-v1/MINIAOD','/DoubleEG/Run2017B-v1/RAW'],
            ['/DoubleEG/Run2017C-31Mar2018-v1/MINIAOD','/DoubleEG/Run2017C-v1/RAW'],
            #['/DoubleEG/Run2017D-31Mar2018-v1/MINIAOD','/DoubleEG/Run2017D-v1/RAW'],
            ['/DoubleEG/Run2017E-31Mar2018-v1/MINIAOD','/DoubleEG/Run2017E-v1/RAW'],
            ['/DoubleEG/Run2017F-31Mar2018-v1/MINIAOD','/DoubleEG/Run2017F-v1/RAW'],
