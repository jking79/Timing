...
def docrab():
    ...
    if options.crabCmd == 'submit':
        ...
        inputRuns  =   'All'
	     ...
	     #secInputPaths = '/DoubleEG/Run2017B-v1/RAW'
        #secInputPaths = '/DoubleEG/Run2017C-v1/RAW'
        #secInputPaths = '/DoubleEG/Run2017D-v1/RAW'
        #secInputPaths = '/DoubleEG/Run2017E-v1/RAW'
        #secInputPaths = '/DoubleEG/Run2017F-v1/RAW'

        #secInputPaths = '/DoubleEG/Run2016H-v1/RAW'
		  secInputPaths = '/DoubleEG/Run2016G-v1/RAW'
        #secInputPaths = '/DoubleEG/Run2016F-v1/RAW'
        #secInputPaths = '/DoubleEG/Run2016E-v1/RAW'
        #secInputPaths = '/DoubleEG/Run2016D-v1/RAW'
        #secInputPaths = '/DoubleEG/Run2016C-v1/RAW'
