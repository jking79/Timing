...
## other info
#diphodir="test"
#diphodir="local_diff_2_Run2017"
#diphodir="local_same_nocut2_Run2017"
diphodir="local_inc_nvtx_cut6_Run2017"
#diphodir="global_inc_E120u_Run2017"
#diphodir="global_inc_nvtx_cut6_Run2017"

#diphodir="phoE_highonly_local_same_Run2017"
...
#Zee="Global dispho_Zee_Run2017 dispho_DiXtal_2017B always_true"
Zee="Local dispho_DiXtal_Run2017 dispho_Zee_2017B always_true"
...
nvxt_cut0="1"
nvxt_cut1="nvtx<=10"
nvxt_cut2="nvtx>10&&nvtx<=20"
nvxt_cut3="nvtx>20&&nvtx<=30"
nvxt_cut4="nvtx>30&&nvtx<=40"
nvxt_cut5="nvtx>40&&nvtx<=50"
nvxt_cut6="nvtx>50 cut6"

nvxt_cuts="${nvxt_cut6}" # ${nvxt_cut1} ${nvxt_cut2} ${nvxt_cut3} ${nvxt_cut4} ${nvxt_cut5} ${nvxt_cut6}"
#echo ${nvxt_cuts}

for nvxt_cut in ${nvxt_cuts}
do
	
	echo "Working with ${nvxt_cut} ${cut_t}"
	#E_cut='1'
	E_cut="(phoseedE_0>=1)&&(phoseedE_0<=120)&&(phoseedE_1>=10)&&(phoseedE_1<=120)"
	#E_cut="(phoseedE_0>=120)&&(phoseedE_1>=120)"
